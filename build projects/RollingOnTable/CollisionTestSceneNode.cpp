...
namespace FrostTest
{
	CollisionSceneNode::CollisionSceneNode(irr::scene::ISceneNode* parent, irr::scene::ISceneManager* mgr, irr::s32 id, std::shared_ptr<Frost::IPhysicsNode> node)
	...
	void CollisionSceneNode::OnRegisterSceneNode()
	{
		if (IsVisible)
		{
	...
	void CollisionSceneNode::render()
	{
	...
	void CollisionSceneNode::updateAbsolutePosition()
	{
